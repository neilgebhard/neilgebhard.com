...
export default function About() {
  return (
    <section className="max-w-3xl mx-auto mb-20">
      ...
      <motion.div
        className="bg-white p-5 shadow-lg md:rounded-md text-xl"
      ...
      >
        <p>
          Growing up, I loved puzzles and math came natural. To me, programs are
          just like interesting puzzles waiting to be solved. My ultimate goal
        ...
        <p>
          ...
          implementation. In my free time, I enjoy playing soccer and video
          gaming.
        </p>
      </motion.div>
    </section>
